...
<div class="content">
	...
	<button onclick="window.location.href='index.php'" class="button-1">DESEA VOLVER?</button>
	
</div>

<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/2.0.1/TweenMax.min.js'></script>
<script src='//s3-us-west-2.amazonaws.com/s.cdpn.io/16327/CustomEase.min.js?r=2'></script><script  src="js/404.js"></script>
